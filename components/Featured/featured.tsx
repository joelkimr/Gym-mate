          ...
          <div className="lg:grid lg:grid-cols-4 lg:grid-rows-2 lg:gap-4 h-full lg:mt-2 md:flex md:flex-col md:gap-5 flex flex-col  gap-10">
            <div className="item-0-div md:min-h-max min-h-[40rem] relative ">
              ...
              <div className="absolute z-10 bottom-10 left-10">
                ...
                <p className="text-white bg-[#FF0336] md:text-lg lg:text-sm rounded-md text-4xl mt-3 md:py-1 py-3 px-5">
        ...
        <div className="container page-padding">
          <div className="flex items-center">
            <h2 className="text-white font-bold text-2xl max-w-6xl px-7">
             ...
             <Link href="/joinClass">
            <div className="bg-white w-44 text-center text-black/90 text-sm font-[600] p-4 hover:border hover:border-white hover:bg-[#FF0336] hover:text-white transition duration-300 rounded-md ">
             JOIN US ...
            </div>
            </Link>
          </div>
