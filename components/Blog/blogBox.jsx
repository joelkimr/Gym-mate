  ...
  return (
    <>
      <div className='md:w-96 w-full md:shadow-xl shadow-2xl flex flex-col px-7 py-8 hover:scale-y-105 hover:scale-x-105 hover:bg-gray-100 '>
        ...
        <Link
          href='/blogs'
          className='md:text-lg text-2xl lg:text-xs uppercase font-bold mt-10 md:w-44 w-60 md:h-14 lg:w-36 h-24 lg:h-9 bg-[#FF0336] text-white text-center md:pt-4 md:p-3 p-6 lg:pt-2 rounded-lg md:rounded-md'>
          Read more
        </Link>
      </div>
    </>
