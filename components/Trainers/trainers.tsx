      ...
      <section className="trainers-section w-full">
        <div className="container page-padding py-28">
          <div className="flex flex-col items-center text-center relative">
            <p className="text-white relative z-10 md:text-lg uppercase font-bold md:mb-10 text-3xl lg:text-sm md:pt-0 pt-5 md:ml-0 ml-20">
              gym trainers
            </p>
            <Image
              src={TitleRed}
              alt="text_bg"
              className="md:w-64 w-[35rem] lg:w-44 absolute -top-1 md:ml-0 ml-16"
            />
